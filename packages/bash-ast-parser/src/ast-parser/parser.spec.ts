import { parseZshFunctions } from './parser';
...
describe('parseZshFunctions', () => {
        ...
        functions: [
          {
            ...
            doxygen: {
              description:
                'This function does something useful It spans multiple lines and should be stored correctly in the output.',
              usage: 'multiLineFunc'
            }
          }
        ]
  ...
  cases.forEach(({ name, input, expected }) => {
    test(name, () => {
      const result = parseZshFunctions(input);
